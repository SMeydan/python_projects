...
"background-color: rgb(176, 149, 147);")
        ...
        self.tableWidget.setGeometry(QtCore.QRect(20, 430, 901, 371))
        self.tableWidget.setStyleSheet("selection-color: rgb(176, 149, 147);")
        ...
        self.tableWidget_2.setGeometry(QtCore.QRect(510, 10, 241, 91))
    ...
    def retranslateUi(self, MainWindow):
        ...
        item.setText(_translate("MainWindow", "HMI"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "HMI_VALUES"))
        item = self.tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "AXIS"))
        item = self.tableWidget.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "AXIS_VALUES"))
        item = self.tableWidget.horizontalHeaderItem(4)
        item.setText(_translate("MainWindow", "USER"))
        item = self.tableWidget.horizontalHeaderItem(5)
        item.setText(_translate("MainWindow", "USER_VALUES"))
        ...
        item.setText(_translate("MainWindow", "REAL"))
